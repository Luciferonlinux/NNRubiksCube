...
original: MattD18 https://github.com/MattD18/rubiks-cube.git
modified by Jón Luykx
"""

# todo: create a print or repr for showing the cube in expanded form like in pycuber
...
class Cube:
    ...
    func_list : list
        list of possible rotations that can be performed to cube
